            ...
            <form method="POST" action="{{ route('admin.course.store') }}" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    <div class="col-6">
                        ...
                        <select class="custom-select select2 {{ $errors->has('category') ? 'is-invalid' : '' }}"
                    ...
                    <div class="col-2">
                        <img src="{{ asset('images/blank.jpeg') }}" class="img-thumbnail btn btn-outline-primary"
                ...
                <div class="form-group">
                    ...
                    <select name="color">
                        @foreach ($colors as $color)
                            <option value="{{ $color }}" {{ old('color', '#ffffff') == $color ? 'selected' : '' }}>
                                {{ $color }}</option>
                        @endforeach
                    </select>
