                        ...
                        @foreach ($announcements as $announcement)
                            <tr>
                                ...
                                <td>
                                    {{ $announcement->date }}
                                    <br />
                                    <span class="text-muted">{{ $announcement->time }}</span>
                                </td>
                                <td>
                                    <div class="xzoom-thumbs text-left">
                                        <img src="{{ asset('storage/image/' . $announcement->thumbnail) }}"
                                            class="btn btn-outline-primary xzoom-gallery img-thumbnail" id="img_thumbnail"
                                            xpreview="{{ asset('storage/image' . $announcement->thumbnai) }}"
                            ...
                            @endforeach --}}
                                ...
                                <td>
                                    ...
                                    <a class="btn btn-xs btn-primary"
                                        href="{{ route('admin.announcement.show', $announcement->id) }}">
                                        {{ trans('global.view') }}
                                    </a>
                                    ...
                                    <div class="pt-2">{{ $announcement->view }} view</div>
