...
<div class="card">
    <div class="card-header">
        <?php echo e(trans('global.edit'), false); ?> Course
    </div>

    <div class="card-body">
        <form method="POST" action="<?php echo e(route("admin.course.update",$course->id), false); ?>" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            ...
            <div class="form-group row">
                <div class="col-6">
                    ...
                    <input class="form-control <?php echo e($errors->has('name') ? 'is-invalid' : '', false); ?>" type="text" name="name" id="name" value="<?php echo e(old('name', $course->name), false); ?>" required>
                    ...
                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($category, false); ?>" <?php echo e($course->category == $category ? 'selected' : '', false); ?>><?php echo e($category, false); ?></option>
                ...
                <div class="col-4">
                 ...
                 <select name="language" id="language" class="custom-select">
                  <?php $__currentLoopData = $languages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $language): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                     <option value="<?php echo e($language, false); ?>" <?php echo e($course->language == $language ? 'selected' : '', false); ?>><?php echo e($language, false); ?></option>
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                 </select>
                  <?php if($errors->has('name')): ?>
                      <div class="invalid-feedback">
                ...
                <div class="col-2">
                    <img src="<?php echo e(empty($course->image)?asset('images/blank.jpeg'): asset('storage/image/' . $course->image), false); ?>" class="img-thumbnail btn btn-outline-primary" id="img_thumbnail" alt="select thumbnail" width="150px" height="150px">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" name="description" id="description"><?php echo e(old('description', $course->description), false); ?></textarea>
                <span class="help-block"></span>
            </div>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 <?php echo e($errors->has('class') ? 'is-invalid' : '', false); ?>" name="class_id[]" id="class_id" multiple>
                    <?php $__currentLoopData = $classes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $class): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if(in_array($id, $filter[strtolower($course->category)])): ?>
                        <option value="<?php echo e($id, false); ?>" <?php echo e((in_array($id, old('class_id', [])) || $course->class->contains($id))  ? 'selected' : '', false); ?>><?php echo e($class, false); ?></option>
                        <?php endif; ?>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
            ...
            <div class="form-group">
                ...
                <?php $__currentLoopData = $colors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $color): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                   <option value="<?php echo e($color, false); ?>" <?php echo e((old('color')==$course->color || $color==$course->color) ? 'selected':'', false); ?>><?php echo e($color, false); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>      
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wrok_in_ics\school_v4\resources\views/admin/course/edit.blade.php ENDPATH**/ ?>