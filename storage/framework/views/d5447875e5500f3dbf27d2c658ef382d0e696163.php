            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" enctype="multipart/form-data" id="upload_image_form"
                        action="<?php echo e(route('admin.homework.store'), false); ?>">
                        <?php echo csrf_field(); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name='classes' id="classes" class="custom-select select2">
                                        <?php $__currentLoopData = $classes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $class): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($class->id, false); ?>"><?php echo e($class->name, false); ?> (<?php echo e($class->campus, false); ?>)
                                            </option>
                            ...
                            <div class="col-4">
                                <div class="form-group">
                                    ...
                                    <div class="align-items-center">
                                        <input name="name" type="text" required="true" value=""
                                            placeholder="Title..." maxlength="100" class="form-control" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <div class="row g-2 align-items-center">
                                        <div class="col">
                                            <input name="marks" type="number" min="1" max="100"
                                        ...
                                        success: function(result) {
                                            if (result.status == 'success') {
                                                ...
                                                if (thisDropzone.files.length > 0)
                                                    ...
                                                    $(".alert-success").html(
                                                        "<p>The Homework has been Added.</p>"
                                                        );
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wrok_in_ics\school_v4\resources\views/admin/homework/create.blade.php ENDPATH**/ ?>