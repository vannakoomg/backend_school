...
<?php $__env->startSection('content'); ?>
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" id="myFrom" action="<?php echo e(route('admin.users.store'), false); ?>" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <div class="row">
                    <div class="col-5">
                        ...
                        <div class="col-5">
                            <div class="form-group">
                                ...
                                <select class="form-control select2 <?php echo e($errors->has('class') ? 'is-invalid' : '', false); ?>"
                                    ...
                                    <?php $__currentLoopData = $classes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $class): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($id, false); ?>"
                                            <?php echo e(old('class_id') == $id ? 'selected' : '', false); ?>>
                                            <?php echo e($class, false); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                                <?php if($errors->has('class')): ?>
                        ...
                        <div class="col-5">
                            <div class="form-group">
                                ...
                                <input class="form-control <?php echo e($errors->has('rfidcard') ? 'is-invalid' : '', false); ?>" readonly
                                    type="text" name="rfidcard" id="rfidcard" value="<?php echo e(old('rfidcard'), false); ?>">
                ...
                <div class="form-group">
                    <button class="btn btn-success" id="submitFormBtn">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input id="history_end_date" name="history_end_date" type="text"
                                                class="form-control datetimepicker ">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <form id="study_history_form ">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            <div class="form-group">
                                                <label>End Date </label>
                                                <input id="edit_history_end_date" type="text"
                                                    class="form-control datetimepicker <?php echo e($errors->has('name') ? 'is-invalid' : '', false); ?>"
                                                    value="<?php echo e(old('name', ''), false); ?>" required>
                                            </div>
                                        </div>
                                ...
                                <form id="sibling_form ">
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <div class="form-group">
                                                <label>Birth Date</label>
                                                <input id="edit_sibling_birth_date" type="text"
                                                    class="form-control datetimepicker">
                                            </div>
                                        </div>
                                        <div class="col">
    ...
    <script>
        ...
        function addParent() {
            if ($('#parent_name').val() != "" || $('#parent_nationality').val() != "" || $('#work_address').val() != "" ||
                ...
                var checkbox2Checked = $('#fatherCheck').prop('checked');
        ...
        function addStudyHistory() {
            if ($('#school_name').val() != "" || $('#location').val() != "" || $('#language').val() != "" || $(
                    '#level').val() != "" || $('#history_start_date').val() != "" || $('#history_end_date').val() != "") {
                var school_name = $('#school_name').val();
                var location = $('#location').val();
                var language = $('#language').val();
                var level = $('#level').val();
                var history_start_date = $('#history_start_date').val();
                var history_end_date = $('#history_end_date').val();
                var newRow = '<tr>' +
                    // '<td>' + i + '</td>' +
                    '<td>' + school_name + '</td>' +
                    '<td>' + location + '</td>' +
        ...
        function editStudyHistory(button) {
            ...
            $('#edit_history_end_date').val(row[5] ?? '');
        ...
        function updateStudtHistory(buttton) {
            ...
            cells[5].innerHTML = $('#edit_history_end_date').val();
        ...
        $('#submitFormBtn').click(function() {
            ...
            if ($('#present_class').val() != "" && $('#name').val() != "" && $('#email').val() !=
                "" &&
                $('#password').val() != "" && $('#phone').val() != "" && $('#nationality').val() !=
                "" &&
                $('#birth_date').val() != "" && $('#class_id').val() != "" && $('#start_date')
                .val() != "") {
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\VANNAK\Desktop\backend_school\resources\views/admin/users/create.blade.php ENDPATH**/ ?>