        ...
        <form method="POST" action="<?php echo e(route("admin.users.update", [$user->id]), false); ?>" enctype="multipart/form-data">
            ...
            <div class="col-6">
                <div class="form-group">
                    ...
                    <select class="form-control select2 <?php echo e($errors->has('class') ? 'is-invalid' : '', false); ?>" name="course_id[]" id="course_id" multiple>
                        <?php $__currentLoopData = $courses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($id, false); ?>" <?php echo e((in_array($id, old('course_id', [])) || $user->courseteacher->contains($id))  ? 'selected' : '', false); ?>><?php echo e($course, false); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wrok_in_ics\school_v4\resources\views/admin/users/edit.blade.php ENDPATH**/ ?>