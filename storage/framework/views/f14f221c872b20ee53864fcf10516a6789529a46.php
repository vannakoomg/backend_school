                                ...
                                <div class="col-4">
                                    <div class="form-group text-nowrap align-bottom">
                                        ...
                                        <audio controls autoplay
                                            ...
                                            <?php if($user->voice): ?>
                                                <source src="<?php echo e(asset('storage/audio/' . $user->voice), false); ?>"
                                                    type="audio/mp3">
                                            <?php endif; ?>
                                        </audio>
                                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-6">
                            <div class="mb-1 ">
                                ...
                                <input type="checkbox" id="is_checkout" name="is_checkout" value="1"
                                    <?php echo e($user->is_checkout ? 'checked' : '', false); ?> class="mr-2">
                                self-checkout
                            </div>
                        </div>
                    </div>
