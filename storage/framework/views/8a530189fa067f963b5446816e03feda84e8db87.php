...
<div class="card">
    <div class="card-header">
        <?php echo e(trans('global.create'), false); ?> <?php echo e(trans('cruds.role.title_singular'), false); ?>

    </div>

    <div class="card-body">
        <form method="POST" action="<?php echo e(route("admin.roles.store"), false); ?>" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            <div class="form-group">
                <label class="required" for="title"><?php echo e(trans('cruds.role.fields.title'), false); ?></label>
                <input class="form-control <?php echo e($errors->has('title') ? 'is-invalid' : '', false); ?>" type="text" name="title" id="title" value="<?php echo e(old('title', ''), false); ?>" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 <?php echo e($errors->has('permissions') ? 'is-invalid' : '', false); ?>" name="permissions[]" id="permissions" multiple required>
                    <?php $__currentLoopData = $permissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $permissions): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($id, false); ?>" <?php echo e(in_array($id, old('permissions', [])) ? 'selected' : '', false); ?>><?php echo e($permissions, false); ?></option>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\VANNAK\Desktop\backend_school\resources\views/admin/roles/create.blade.php ENDPATH**/ ?>