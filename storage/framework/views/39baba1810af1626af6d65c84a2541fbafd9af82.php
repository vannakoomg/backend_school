           ...
           <div class="col-3 text-center">
                ...
                <div class="btn-group" role="group">
                    ...
                    <button id="btnGroupDrop1" type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        ...
                        <?php elseif(request('category')==5): ?>
                                Monitoring-Primary
                        <?php elseif(request('category')==6): ?>
                    ...
                    <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                        ...
                        <?php if(request('category')!=3): ?>
                            <a class="dropdown-item" href="<?php echo e(route("admin.calling.dashboard",['MC','3']), false); ?><?php echo e(request()->length ? '?length=0' : '', false); ?>">Monitoring-ALL</a>
                        <?php endif; ?>
                        <?php if(request('category')!=4): ?>
                            <a class="dropdown-item" href="<?php echo e(route("admin.calling.dashboard",['MC','4']), false); ?><?php echo e(request()->length ? '?length=0' : '', false); ?>">Monitoring-Kindergarten</a>
                        <?php endif; ?>
                        <?php if(request('category')!=5): ?>
                            <a class="dropdown-item" href="<?php echo e(route("admin.calling.dashboard",['MC','5']), false); ?><?php echo e(request()->length ? '?length=0' : '', false); ?>">Monitoring-Primary</a>
                        <?php endif; ?>
                        <?php if(request('category')!=6): ?>
                            <a class="dropdown-item" href="<?php echo e(route("admin.calling.dashboard",['MC','6']), false); ?><?php echo e(request()->length ? '?length=0' : '', false); ?>">Monitoring-Secondary</a>
                        <?php endif; ?>
...
<script>
    ...
    $(document).ready(function(){
       ...
       // "deferLoading": 0,
        ...
        bInfo:false,
        ajax: {
            url:"<?php echo e(route('admin.calling.getwaiting'), false); ?>?campus=" + selectCampus + '&category=<?php echo e(request("category"), false); ?>&startrow=' + ((startrow + lengthrow ) * next_page) + '&lengthrow=' + lengthrow,
        ...
        ajax: {
            url:"<?php echo e(route('admin.calling.getwaiting'), false); ?>?campus=" + selectCampus + '&category=<?php echo e(request("category"), false); ?>&startrow=' + ((startrow + (lengthrow * 2) ) * next_page)  + '&lengthrow=' + lengthrow,
        ...
        // bInfo:false,
        // ajax: {
        //     url:"<?php echo e(route('admin.calling.getwaiting'), false); ?>?campus=" + selectCampus + '&category=<?php echo e(request("category"), false); ?>&startrow=' + (startrow + (lengthrow * 3) * next_page ) + '&lengthrow=' + lengthrow,
    ...
    //    },4000);
        ...
        tableTimeInterval=setInterval(function(){
            ...
            console.log("Page:" + next_page + 'of Total ' + total_page);
                       ...
                       table1.ajax.url("<?php echo e(route('admin.calling.getwaiting'), false); ?>?campus=" + selectCampus + '&category=<?php echo e(request("category"), false); ?>&startrow=' + ((next_page -1) * lengthrow) + '&lengthrow=' + lengthrow).load();
                       table2.ajax.url("<?php echo e(route('admin.calling.getwaiting'), false); ?>?campus=" + selectCampus + '&category=<?php echo e(request("category"), false); ?>&startrow=' + ((next_page1-1) * lengthrow) + '&lengthrow=' + lengthrow).load();
                       table3.ajax.url("<?php echo e(route('admin.calling.getwaiting'), false); ?>?campus=" + selectCampus + '&category=<?php echo e(request("category"), false); ?>&startrow=' +  ((next_page2-1) * lengthrow)  + '&lengthrow=' + lengthrow).load();
                       //table4.ajax.url("<?php echo e(route('admin.calling.getwaiting'), false); ?>?campus=" + selectCampus + '&category=<?php echo e(request("category"), false); ?>&startrow=' +  ((next_page3-1) * lengthrow)  + '&lengthrow=' + lengthrow).load();
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\VANNAK\Desktop\backend_school\resources\views/admin/calling/dashboard.blade.php ENDPATH**/ ?>