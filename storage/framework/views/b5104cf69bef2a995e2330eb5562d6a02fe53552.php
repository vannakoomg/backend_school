...
<div class="card">
    ...
    <form name="frmcampus" method="get" action="<?php echo e(route("admin.homework.completed"), false); ?>" enctype="multipart/form-data">
        <div class="row">
        <div class="col">
            <h3>Completed <?php echo e(trans('global.list'), false); ?></h3>
        </div>
...
<script>
   ...
   // $.fn.dataTable.ext.errMode = 'none';
       ...
       // "deferLoading": 0,
        ajax: {
            'dataType':'json',
            url:"<?php echo e(route('admin.homework.ajaxhomework'), false); ?>?completed=1",
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\VANNAK\Desktop\backend_school\resources\views/admin/homework/completed.blade.php ENDPATH**/ ?>