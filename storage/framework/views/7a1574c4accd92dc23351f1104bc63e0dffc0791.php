                            ...
                            <tr data-entry-id="<?php echo e($role->id, false); ?>">
                                ...
                                <td>
                                    ...
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('role_delete')): ?>
                                        <form action="<?php echo e(route('admin.roles.destroy', $role->id), false); ?>" method="POST"
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\VANNAK\Desktop\backend_school\resources\views/admin/roles/index.blade.php ENDPATH**/ ?>