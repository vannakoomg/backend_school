        ...
        <div class="card-body">
            <form method="POST" action="<?php echo e(route('admin.events.update', $event->id), false); ?>" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" type="text" name="time" id="name" value="<?php echo e($event->time, false); ?>">
                </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\VANNAK\Desktop\backend_school\resources\views/admin/events/edit.blade.php ENDPATH**/ ?>