            ...
            <form method="POST" action="<?php echo e(route('admin.course.store'), false); ?>" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    <div class="col-6">
                        ...
                        <select class="custom-select select2 <?php echo e($errors->has('category') ? 'is-invalid' : '', false); ?>"
                            ...
                            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($category, false); ?>" <?php echo e(old('category') == $category ? 'selected' : '', false); ?>>
                                    <?php echo e($category, false); ?></option>
                    ...
                    <div class="col-4">
                        ...
                        <select name="language" id="language" class="custom-select">
                            <?php $__currentLoopData = $languages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $language): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($language, false); ?>" <?php echo e(old('language') == $language ? 'selected' : '', false); ?>>
                                    <?php echo e($language, false); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                        <?php if($errors->has('name')): ?>
                            <div class="invalid-feedback">
                    ...
                    <div class="col-2">
                        <img src="<?php echo e(asset('images/blank.jpeg'), false); ?>" class="img-thumbnail btn btn-outline-primary"
                            id="img_thumbnail" alt="select thumbnail" width="150px" height="150px">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control select2 <?php echo e($errors->has('class') ? 'is-invalid' : '', false); ?>" name="class_id[]"
                        id="class_id" multiple>
                ...
                <div class="form-group">
                    ...
                    <select name="color">
                        <?php $__currentLoopData = $colors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $color): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($color, false); ?>" <?php echo e(old('color', '#ffffff') == $color ? 'selected' : '', false); ?>>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\VANNAK\Desktop\backend_school\resources\views/admin/course/create.blade.php ENDPATH**/ ?>