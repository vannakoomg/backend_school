                        ...
                        <?php $__currentLoopData = $announcements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $announcement): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <br />
                                    <span class="text-muted"><?php echo e($announcement->time, false); ?></span>
                                </td>
                                <td>
                                    <div class="xzoom-thumbs text-left">
                                        <img src="<?php echo e(asset('storage/image/' . $announcement->thumbnail), false); ?>"
                                            class="btn btn-outline-primary xzoom-gallery img-thumbnail" id="img_thumbnail"
                                            xpreview="<?php echo e(asset('storage/image' . $announcement->thumbnai), false); ?>"
                                ...
                                <td>
                                    ...
                                    <a class="btn btn-xs btn-primary"
                                        href="<?php echo e(route('admin.announcement.show', $announcement->id), false); ?>">
                                        <?php echo e(trans('global.view'), false); ?>

                                    </a>

                                    <a class="btn btn-xs btn-info"
                                        href="<?php echo e(route('admin.announcement.edit', $announcement->id), false); ?>">
                                        <?php echo e(trans('global.edit'), false); ?>

                                    </a>

                                    <form action="<?php echo e(route('admin.announcement.destroy', $announcement->id), false); ?>"
                                    ...
                                    <div class="pt-2"><?php echo e($announcement->view, false); ?> view</div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\VANNAK\Desktop\backend_school\resources\views/admin/announcement/index.blade.php ENDPATH**/ ?>